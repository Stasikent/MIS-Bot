...
class RuntimeClickPickOverlay(tk.Toplevel):
...
def pick_runtime_point(parent, title_text="Кликни в нужную точку"):
    overlay = RuntimeClickPickOverlay(parent, title_text=title_text)
