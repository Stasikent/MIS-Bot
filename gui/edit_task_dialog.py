...
class EditTaskDialog(tk.Toplevel):
    def __init__(self, master, task):
        ...
        self.fio_var = tk.StringVar(value=task.fio)
        self.birth_var = tk.StringVar(value=task.birth_date)
        self.study_var = tk.StringVar(value=task.study_date)
        self.mode_var = tk.StringVar(value=INTERNAL_TO_UI_MODE.get(task.mode, "Норма"))
        self.note_var = tk.StringVar(value=task.note or "")
